      ...
      <div className='bg-black h-full w-full text-white sm:flex sm:justify-around about py-12 mt-8 overflow-x-hidden' id='about'>
        <div className='flex flex-col justify-around'>
          <div className='sm:px-16 px-2'>
            ...
            <p className='mt-3 mb-6 text-[17px] max-w-3xl leading-[30px]'>👨‍💻 Hi, I'm Yash Lunawat, a 2027 graduate🎓 with a passion for crafting robust backend systems and captivating mobile applications.As a seasoned <a className='text-green-300 hover:text-green-500 duration-300' href='https://www.linkedin.com/in/yash-lunawat-/' target='_blank'>Software developer</a> I specialize in both MEAN and MERN stacks🚀.
              <br />
            ...
            <ButtonLink
              url='https://resume.yashlunawat.com/'
              text='View Resume →'
              padding={`p-3`}
            />
